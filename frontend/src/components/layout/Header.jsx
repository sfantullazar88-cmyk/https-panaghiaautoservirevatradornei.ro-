      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link to="/comanda" className="text-gray-700 hover:text-[#D4A847] transition-colors relative">
              <ShoppingBag className="w-5 h-5" />
              {cartItemCount > 0 && (
                <span className="absolute -top-2 -right-2 w-5 h-5 bg-[#D4A847] text-white text-xs rounded-full flex items-center justify-center">
                  {cartItemCount}
                </span>
              )}
            </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button className="w-10 h-10 border border-gray-300 rounded-full flex items-center justify-center hover:border-[#D4A847] hover:text-[#D4A847] transition-colors">
